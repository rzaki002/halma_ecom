...
Route::post('updatePembayaran',[OrderController::class,'updatePembayaran'])->name('updatePembayaran');


Route::get('ordercustomer', [OrderController::class, 'ordercustomer'])->name('ordercustomer');
Route::get('cobamidtrans',[OrderController::class,'cobamidtrans'])->name('cobamidtrans');
Route::get('laporan_penjualan',[Order_detailController::class,'report'])->name('laporan_penjualan');